...
export const PRODUCTS: Product[] = [
  {
    ...
    shortName: '주방봉사자',
    price: 4000,
    description: ['귀여운 주방봉사자와 스펀지 참이 한 세트!', ...LION_SET_DESC],
    category: 'keyring',
    bg: 'var(--color-lavender)',
    photo: '/sponge-lion.webp',
    detailImage: '/sponge-lion-detail.webp',
    specs: [
      { label: '사이즈', value: '사자 46×44mm · 스펀지 참 26×24mm' },
      { label: '재질', value: '투명하고 튼튼한 아크릴' },
      { label: '구성', value: '2종 세트 (사자 + 스펀지 참)' },
  ...
  },
  {
    ...
    shortName: '식사봉사자',
    price: 4000,
    description: ['귀여운 식사봉사자와 주걱 참이 한 세트!', ...LION_SET_DESC],
    category: 'keyring',
    bg: 'var(--color-pink)',
    photo: '/spatula-lion.webp',
    detailImage: '/spatula-lion-detail.webp',
    specs: [
      { label: '사이즈', value: '사자 48×41mm · 주걱 참 25×25mm' },
      { label: '재질', value: '투명하고 튼튼한 아크릴' },
      { label: '구성', value: '2종 세트 (사자 + 주걱 참)' },
      { label: '키링 타입', value: '열고 닫기 쉬운 D링' },
    ],
    isNew: true,
    stock: 50,
  ...
  },
  {
    ...
    shortName: '미선부봉사자',
    price: 4000,
    description: ['귀여운 미선부봉사자와 아아 참이 한 세트!', ...LION_SET_DESC],
    category: 'keyring',
    bg: 'var(--color-cream)',
    photo: '/coffee-lion.webp',
    detailImage: '/coffee-lion-detail.webp',
    specs: [
      { label: '사이즈', value: '사자 51×39mm · 아아 참 31×19mm' },
      { label: '재질', value: '투명하고 튼튼한 아크릴' },
      { label: '구성', value: '2종 세트 (사자 + 아아 참)' },
      { label: '키링 타입', value: '열고 닫기 쉬운 D링' },
    ],
    isNew: true,
    stock: 50,
  ...
  {
    id: 'snack-lion',
    name: 'TFT봉사자 키링 + 회오리감자 참',
    shortName: 'TFT봉사자',
    price: 4000,
    description: ['귀여운 TFT봉사자와 회오리감자 참이 한 세트!', ...LION_SET_DESC],
    category: 'keyring',
    bg: 'var(--color-cream)',
    photo: '/snack-lion.webp',
    detailImage: '/snack-lion-detail.webp',
    specs: [
      { label: '사이즈', value: '사자 47×43mm · 회오리감자 참 35×14mm' },
      { label: '재질', value: '투명하고 튼튼한 아크릴' },
      { label: '구성', value: '2종 세트 (사자 + 회오리감자 참)' },
      { label: '키링 타입', value: '열고 닫기 쉬운 D링' },
    ],
    isNew: true,
    stock: 50,
  ...
  {
    id: 'bible-lion',
    name: '기도하계사자 키링 + 성경책 참',
    shortName: '기도하계사자',
    price: 4000,
    description: ['귀여운 기도하계사자와 성경책 참이 한 세트!', ...LION_SET_DESC],
    category: 'keyring',
    bg: 'var(--color-cream)',
    photo: '/bible-lion.webp',
    detailImage: '/bible-lion-detail.webp',
    specs: [
      { label: '사이즈', value: '사자 51×39mm · 성경책 참 28×22mm' },
      { label: '재질', value: '투명하고 튼튼한 아크릴' },
      { label: '구성', value: '2종 세트 (사자 + 성경책 참)' },
      { label: '키링 타입', value: '열고 닫기 쉬운 D링' },
    ],
    isNew: true,
    stock: 50,
  ...
  },
  {
    ...
    bg: 'var(--color-pink)',
    photo: '/tshirt-3.webp',
    sizeStock: { S: 3, M: 5, L: 15, XL: 5, XXL: 2 },
