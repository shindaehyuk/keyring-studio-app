...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'coffee-lion',
    name: '미선부봉사자 키링 + 아이스커피 참',
    shortName: '미선부봉사자',
    price: 4000,
    description: ['귀여운 미선부봉사자와 아이스커피 참이 한 세트!', ...LION_SET_DESC],
    category: 'keyring',
    bg: 'var(--color-cream)',
    photo: '/coffee-lion.webp',
    detailImage: '/coffee-lion-detail.webp',
    specs: [
      { label: '사이즈', value: '사자 51×39mm · 아이스커피 참 31×19mm' },
      { label: '재질', value: '투명하고 튼튼한 아크릴' },
      { label: '구성', value: '2종 세트 (사자 + 아이스커피 참)' },
      { label: '키링 타입', value: '열고 닫기 쉬운 D링' },
    ],
    isNew: true,
    stock: 50,
  ...
  {
    id: 'bible-lion',
    name: '기도하게사자 키링 + 성경책 참',
    shortName: '기도하게사자',
    price: 4000,
    description: ['귀여운 기도하게사자와 성경책 참이 한 세트!', ...LION_SET_DESC],
    category: 'keyring',
    bg: 'var(--color-cream)',
