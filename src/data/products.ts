...
export const PRODUCTS: Product[] = [
  {
    ...
    shortName: '주방봉사자',
    price: 4000,
    description: ['주방봉사 나가는 사자와 스펀지 참이 한 세트!', ...LION_SET_DESC],
    category: 'keyring',
  ...
  },
  {
    ...
    shortName: '식사봉사자',
    price: 4000,
    description: ['식사봉사 나가는 사자와 주걱 참이 한 세트!', ...LION_SET_DESC],
    category: 'keyring',
    bg: 'var(--color-pink)',
  ...
  },
  {
    ...
    shortName: '미선부봉사자',
    price: 4000,
    description: ['미선부 사자와 아이스 아메리카노 참이 한 세트!', ...LION_SET_DESC],
    category: 'keyring',
    bg: 'var(--color-cream)',
  ...
  },
  {
    ...
    shortName: 'TFT봉사자',
    price: 4000,
    description: ['TFT 사자와 회오리감자 참이 한 세트!', ...LION_SET_DESC],
    category: 'keyring',
    bg: 'var(--color-cream)',
  ...
  },
  {
    ...
    shortName: '기도하계사자',
    price: 4000,
    description: ['기도하는 사자와 성경책 참이 한 세트!', ...LION_SET_DESC],
    category: 'keyring',
    bg: 'var(--color-cream)',
